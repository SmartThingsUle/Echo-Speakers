...
def refresh() {
    ...
    log.trace "domain" + parent.appSettings.domain
...
def setCommand(command){
	def params = [
        uri: parent.appSettings.domain + "/api/np/command?deviceSerialNumber=" + getDataValue("serialNumber") + "&deviceType=" + getDataValue("deviceType") ,
        headers:[
            "Csrf": parent.appSettings.csrf,
            "Cookie": parent.appSettings.cookieP1 + parent.appSettings.cookieP2 + parent.appSettings.cookieP3,
        ],
        body:command
	]
...
{
	def params = [
        uri: parent.appSettings.domain + "/api/np/player?deviceSerialNumber=" + getDataValue("serialNumber") + "&deviceType=" + getDataValue("deviceType") ,//+ "&screenWidth=2560"
        headers:[
            "Csrf": parent.appSettings.csrf,
            "Cookie": parent.appSettings.cookieP1 + parent.appSettings.cookieP2 + parent.appSettings.cookieP3,
        ]
...
def playText(msg){
    def params = [
        uri: parent.appSettings.domain + "/api/behaviors/preview",
        headers:[
            "Csrf": parent.appSettings.csrf,
            "Cookie": parent.appSettings.cookieP1 + parent.appSettings.cookieP2 + parent.appSettings.cookieP3,
                ],
